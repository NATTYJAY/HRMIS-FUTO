            ...
            <div class="wrap-login100 p-5">
                ...
                <form method="POST" action="{{ route('admin.student.submit') }}">
                    ...
                    <div class="form-group">
                        <label for="reg" class="col-sm-12 col-form-label text-md-left">Reg No</label>

                        <input id="reg" type="password" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
