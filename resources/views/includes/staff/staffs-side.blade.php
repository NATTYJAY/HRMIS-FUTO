<aside class="app-sidebar ">
    <div class="sidebar-img">
        ...
        <ul class="side-menu">
            <li class="slide">
                <a class="side-menu__item active"  href="{{url('/')}}"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">DashBoard</span></a>
                {{--<ul class="slide-menu">--}}
                    {{--<li>--}}
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{url('/staff/leave')}}"><i class="side-menu__icon fe fe-grid"></i><span class="side-menu__label">Leave</span></a>

            </li>

            {{--<li class="slide">--}}
                {{--<a class="side-menu__item" href="{{url('/staff/profile')}}"><i class="side-menu__icon fe fe-edit"></i><span class="side-menu__label">Profile</span></a>--}}

            {{--</li>--}}
            <li class="slide">
                <a class="side-menu__item"  href="{{url('/staff/memos')}}"><i class="side-menu__icon fe fe-map"></i><span class="side-menu__label">Your Memo</span></a>
                {{--<ul class="slide-menu">--}}
                    {{--<li>--}}
